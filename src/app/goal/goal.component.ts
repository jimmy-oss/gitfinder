...
export class GoalComponent implements OnInit {
  ...
  goals: Goal[] = [
    ...
    new Goal(4,'Count your age by friends', 'Not years. Count your life by smiles, not tears.”John Lennon',new Date(2021,0,18)),
    new Goal(5,'Laughter is timeless', 'Imagination has no age. And dreams are forever.” Walt Disney',new Date(2021,2,14)),
    new Goal(6,'There is only one thing that makes a dream impossible to achieve', 'The fear of failure.”Paulo Coelho',new Date(2021,3,14)),
  ];
